...
backend_args = None
data_root = 'D:/mmdet/project/datasets/'
...
test_evaluator = dict(
    ann_file='D:/mmdet/project/datasets/annotation/val.json',
    backend_args=None,
    format_only=False,
    metric='bbox',
    type='CocoMetric')
...
train_pipeline = [
    ...
    dict(type = 'RandomAffine', scaling_ratio_range = (0.1, 1), border = (-img_scale[0] // 2, -img_scale[1] // 2)),
    dict(type = 'MixUp', img_scale = (1330, 800), ratio_range = (0.8, 1.6), pad_val = 114.0),
    dict(prob=0.5, type='RandomFlip'),
    dict(prob = 0.5, type = 'AutoContrast'),
    dict(prob = 0.5, type = 'Sharpness'),
